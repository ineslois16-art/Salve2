...
| Doré profond (secondaire) | `#F7E75A` (`.theme-it`) | Accent du thème IT — **décision finale** |
...
- Doré profond `#F7E75A` → texte crème `#F6F2EA` ✓ (arbitrage clos)
...
- [x] **Nuance dorée du thème secondaire tranchée** : `#F7E75A` (doré profond)
